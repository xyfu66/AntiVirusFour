...
//	private RelativeLayout rlFlash;
    ...
    public void onCreate(Bundle icicle) {
        ...
        viewCaptureISBN = (FrameLayout) findViewById(R.id.captureIsbn);
        titleBar = (LinearLayout) findViewById(R.id.llTitleBar);
        viewManualInputISBN = (LinearLayout) findViewById(R.id.manualInputIsbn);
