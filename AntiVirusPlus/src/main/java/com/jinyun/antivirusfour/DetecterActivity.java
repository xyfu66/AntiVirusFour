	...
	class FRAbsLoop extends AbsLoop {
		...
		public void loop() {
			if (mImageNV21 != null) {
                ...
                final int aged =  ages.get(0).getAge();//病症检测关键词
				...
				if (max > 0.6f) {
					...
					DetecterActivity.this.runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							if (aged <10 || Objects.equals(age, "年龄未知")){
							    mTextView2.setText(R.string.faceVirus0);
                            }if (aged >=10 && aged <20){
                                mTextView2.setText(R.string.faceVirus10);
                            }if (aged >=20 && aged <30){
                                mTextView2.setText(R.string.faceVirus20);
                            }if (aged >=30 && aged <50){
                                mTextView2.setText(R.string.faceVirus30);
                            }if (aged >=50 && aged <70){
                                mTextView2.setText(R.string.faceVirus50);
                            }if (aged >=70 && aged <150){
                                mTextView2.setText(R.string.faceVirus70);
                            }
