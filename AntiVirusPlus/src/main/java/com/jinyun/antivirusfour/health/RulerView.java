...
public class RulerView extends View {
    ...
    // 默认 身高mPerValue为1  体重mPerValue 为0.1
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimension(R.styleable.RulerView_textSizeRuler,  mTextSize);
        mTextColor = typedArray.getColor(R.styleable.RulerView_textColorRuler, mTextColor);
