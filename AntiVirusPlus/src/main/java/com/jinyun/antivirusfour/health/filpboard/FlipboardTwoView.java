...
/**
 */
public class FlipboardTwoView extends View {
    ...
    public FlipboardTwoView(Context context) {
        super(context);
    }

    public FlipboardTwoView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FlipboardTwoView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        mBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.lumsing_body_grease_scale);
    }
