...
/**
 */
public class FlipboardThreeView extends View {
    ...
    public FlipboardThreeView(Context context) {
        super(context);
    }

    public FlipboardThreeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FlipboardThreeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        mBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.yunmai_body_grease_scale);
    }
