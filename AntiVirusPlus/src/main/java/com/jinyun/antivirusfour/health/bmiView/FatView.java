...
public class FatView extends View {
    ...
    public FatView(Context context) {
            super(context);
            initPainting();
            initBodyCategories();
        }

    public FatView(Context context, AttributeSet attrs) {
            super(context, attrs);
    ...
    private void initBodyCategories() {
        ...
        bodyCategoryList.add(new BodyCategory(VERY_SEVERELY_UNDERWEIGHT, verySeverelyUnderweightColor, getResources().getString(R.string.VERY_SEVERELY_UNDERWEIGHT1), mMin, mMin));
        bodyCategoryList.add(new BodyCategory(SEVERELY_UNDERWEIGHT, severelyUnderweightColor, getResources().getString(R.string.SEVERELY_UNDERWEIGHT1), 11, 21));
        bodyCategoryList.add(new BodyCategory(UNDERWEIGHT, underweightColor, getResources().getString(R.string.UNDERWEIGHT1), 16, 26));
        bodyCategoryList.add(new BodyCategory(NORMAL, normalColor, getResources().getString(R.string.NORMAL1), 21, 31));
        bodyCategoryList.add(new BodyCategory(OVERWEIGHT, overweightColor, getResources().getString(R.string.OVERWEIGHT1), 26, 36));
        bodyCategoryList.add(new BodyCategory(OBESE_CLASS_1, obeseClass1Color, getResources().getString(R.string.OBESE_CLASS_1), 30, 39));
        bodyCategoryList.add(new BodyCategory(OBESE_CLASS_2, obeseClass2Color, getResources().getString(R.string.OBESE_CLASS_2), 35, 43));
    ...
    public void invalidate() {
        if (height == 0f) {
            ...
            bmiValue = (weight / (height * height))*1.2f+0.23f*age-5.4f-10.8f*gender;
    ...
    public FatView setHeight(float height) {
        this.height = height;
        invalidate();
        return this;
    }

    public FatView setWeight(float weight) {
        this.weight = weight;
        invalidate();
        return this;
    }

    public  FatView  setAge(float age){
        this.age=age;
        invalidate();
        return this;
    }
     ...
     * @return BMIView
     */
    public FatView setGender(int gender) {
        this.gender = gender;
        invalidate();
        return this;
    }
